...
<ol>
    ...
    <li><strong>Upcoming Features</strong>: And also user can create new a account with the help of account number that is link with the user credentials and many more....
</ol>
